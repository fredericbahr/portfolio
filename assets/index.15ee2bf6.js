...
`,Wn=({isMounted:e})=>{const{t:n}=D(),[r,i]=W.useState(!1),s=l=>()=>{i(l)},a=r?o(I,{onClick:s(!1),children:o(jn,{})}):o(I,{onClick:s(!0),children:o(Bn,{})});return u(R,{children:[o(In,{children:u(Pn,{children:[o(P,{in:e,timeout:K,children:o($e,{children:o(et,{})})}),o(P,{in:e,timeout:K+pe,children:o($e,{children:a})})]})}),o(En,{anchor:"bottom",open:r,onClose:s(!1),onOpen:s(!0),swipeAreaWidth:56,disableSwipeToOpen:!1,children:u(Hn,{children:[o(Fn,{}),o(kt,{children:ue.map((l,g)=>o(Mt,{children:o(Yn,{children:o(Rn,{smooth:!0,to:l.url,onClick:s(!1),children:n(l.title)})})}))})]})})]})},Nn=c.nav`
  flex: 1;
  display: flex;
  justify-content: end;
  align-items: center;
...
`,Zn=({isMounted:e})=>{const{t}=D();return o(Nn,{children:u(qn,{children:[e&&ue.map((n,r)=>o(P,{in:e,timeout:K+r*pe,children:o(Te,{children:o(Xn,{smooth:!0,to:n.url,children:t(n.title)})},r)},r)),o(P,{in:e,timeout:K+ue.length*pe,children:o(Te,{children:o(et,{})})})]})})},Un=()=>{const[e,t]=x.exports.useState(!1),n=N(`(max-width: ${T.sm})`);return x.exports.useEffect(()=>{const r=setTimeout(()=>t(!0),Tn);return()=>clearTimeout(r)},[]),n?o(Wn,{isMounted:e}):o(Zn,{isMounted:e})},Vn=c(St)`
  flex-direction: row;
  background-color: ${e=>e.theme.colors.mainblack};
  padding: 5px 0;
`,On=c(I)`
...
`,_n=({homeClickHandler:e})=>{const t=vt({target:window,threshold:50}),n=N(`(max-width: ${T.md})`);return u(R,{children:[o(P,{direction:"down",in:!t,timeout:_,children:u(Vn,{color:"inherit",position:n?"absolute":"fixed",children:[o(P,{direction:"down",in:!t,timeout:_,children:o(On,{onClick:e,children:o(Gn,{})})}),o(Un,{})]})}),o(Ct,{})]})},Kn=c.h2`
  font-size: 2rem;
  margin-bottom: 5vh;
  width: 100%;
...
`,fe=({children:e})=>o(Kn,{children:e}),Jn=c.section`
  ...
  height: 100vh;
  margin: 0 auto;
`;function Qn(){const{t:e}=D();return o(Jn,{id:"about",children:o(fe,{children:e("sections.about")})})}var eo="/portfolio/assets/chatbot-avatar.2885f311.svg";const to=c($t)`
  background-color: ${e=>e.theme.colors.mainblack};
  color: ${e=>e.theme.colors.mainwhite};
...
`,Mo=c.img`
  width: 32px;
  height: 32px;
`,So=({type:e,url:t,fileName:n})=>{const r=x.exports.useRef(null),i=fo(r.current),s=()=>{const l=document.createElement("a");document.body.appendChild(l),l.download=n.toString(),l.href=t.toString(),l.click(),document.body.removeChild(l)};return o(R,{children:e==="pdf"?(()=>(console.log("URL:",t),u(wo,{ref:r,children:[o(zt,{onClick:()=>s(),children:o(bo,{children:o(At,{file:t,renderMode:"svg",children:o(yo,{pageNumber:1,height:i.width,loading:o(Lt,{})})})})}),u(xo,{children:[o(Mo,{src:go}),u(ko,{children:[n,".pdf"]}),o(I,{onClick:()=>s(),children:o(It,{})})]})]})))():""})},vo=c(Pt)`
  & .MuiPaper-root {
    background-color: ${e=>e.theme.colors.mainblack};
    color: ${e=>e.theme.colors.whitefontcolor};
  }
...
`,Ho=c.p`
  ...
  hyphens: auto;
`,Fo=({children:e,owner:t})=>o(Ge,{in:!0,appear:!0,children:o(Eo,{owner:t,children:o(Ho,{owner:t,children:e})})}),Yo=c(Ve)`
  flex-grow: 1;
`,Ro=c(Oe)`
  flex-wrap: wrap;
  margin-bottom: 1vmax;
`,Wo=c.div`
  ...
  display: flex;
  flex-direction: column;
`,No=()=>{const{t:e}=D(),[t,n]=x.exports.useState(so),[r,i]=x.exports.useState(co),s=x.exports.useRef(null);x.exports.useEffect(()=>{k()},[t,r]);const a=()=>t.map((p,w)=>lo(p)?o(Fo,{owner:p.owner,children:e(p.message)},w):ho(p)?o(So,{owner:p.owner,type:p.type,fileName:p.fileName,url:p.url},w):mo(p)?o(jo,{formElements:p.formElements,formSubmitID:p.formSubmitID},w):null),l=p=>{const w=[];return p.forEach(M=>{const S=q.get(M);S&&w.push(S)}),w},g=async p=>{i([]);const M=p.messges.map((S,X)=>new Promise(ne=>{setTimeout(()=>{n(oe=>[...oe,S]),ne()},X*1e3)}));await Promise.all(M),i(p.furtherActions?l(p.furtherActions):[])},k=()=>{var p;(p=s==null?void 0:s.current)==null||p.scrollIntoView({behavior:"smooth"})};return u(Wo,{children:[o(Yo,{children:a()}),o(Ro,{children:r.map((p,w)=>o(uo,{handleAction:()=>g(p),children:e(p.actionText)},w))}),o("div",{ref:s})]})},qo=c(Ue)`
  display: flex;
  flex-direction: column;
  position: fixed;
  bottom: 1vmax;
...
`,it=({technologies:e=[],justifyContent:t="flex-start"})=>{const{t:n}=D();return o(Oo,{justifyContent:t,children:e.map((r,i)=>o(Go,{children:n(r)},i))})},_o=c(A)`
  margin: 2vh 0;
  width: 85%;
`,Ko=c.ul`
  margin: 2vh 0;
...
`,tr=e=>me(e,["YYYY-MM-DD"]).isValid(),nr=({from:e,to:t})=>{const{t:n}=D();return u("div",{children:[o(le,{component:"span",children:me(e).format("MMMM YYYY")}),o(le,{component:"span",children:" - "}),o(le,{component:"span",children:tr(t)?me(t).format("MMMM YYYY"):n(t)})]})},or=c.a`
  text-decoration: none;
  color: ${e=>e.theme.colors.mainred};
  transition: ${B};
  position: relative;
...
`,ur=c(lr)`
  align-self: start;
`,gr=()=>{const[e,t]=W.useState(0),{t:n}=D(),r=N(`(max-width: ${T.sm})`),i=r?"horizontal":"vertical";console.log(r);const s=(a,l)=>{t(l)};return u(dr,{id:"experience",children:[o(fe,{children:n("sections.experience")}),u(hr,{children:[Ae.map(a=>u(ur,{value:e,index:a.index,children:[o(ar,{title:n(a.jobTitle),companyName:a.fullCompanyName,companyUrl:a.companyUrl}),o(nr,{from:a.timeRange.from,to:a.timeRange.to}),o(er,{description:a.description}),a.technologies&&o(it,{technologies:a.technologies})]},a.index)),o(mr,{orientation:i,variant:"scrollable",scrollButtons:"auto",allowScrollButtonsMobile:!0,onChange:s,value:e,children:Ae.map(a=>o(pr,{label:n(a.shortCompanyName)},a.index))})]})]})},fr=c.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  padding-bottom: 5vh;
...
`,Ci=c.div`
  ...
  top: 0;
  left: 5%;
`,$i=()=>{const e=x.exports.useRef(null),[t,n]=x.exports.useState(0),[r,i]=x.exports.useState("miniMe.hiBubbleText"),s=6e3,a=N(`(min-width: ${T.md})`),l=O.getMiniMe(),{t:g}=D();x.exports.useEffect(()=>{var ke;const w=new tn;w.clear();const M=new nn(65,window.innerWidth/window.innerHeight,.1,4e3);M.position.set(0,400,-1e3),M.lookAt(new on(0,0,0));const S=new rn({alpha:!0,antialias:!0});S.setPixelRatio(window.devicePixelRatio);const X=new sn(M,S.domElement);X.update(),(ke=e.current)==null||ke.replaceChildren(S.domElement);const ne=()=>{const E=new cn(16777215,16777215,.7),F=new ln(4210752,1.2);w.add(E),w.add(F)},oe=()=>{w.add(l.character)};function ht(){const E=S.domElement,F=E.clientWidth,re=E.clientHeight;(E.width!==F||E.height!==re)&&(S.setSize(F,re,!0),M.aspect=F/re,M.updateProjectionMatrix())}const xe=function(){requestAnimationFrame(xe),ht(),X.update(),S.render(w,M)};ne(),oe(),xe()}),x.exports.useEffect(()=>{l.setGadget(t)},[t]),x.exports.useEffect(()=>{const w=setTimeout(()=>{i(null)},s);return()=>clearTimeout(w)},[r]);const k=[{id:0,icon:o(xi,{}),name:"empty"},{id:1,icon:o(Mi,{}),name:"laptop"},{id:2,icon:o(Si,{}),name:"keyboard"}],p=()=>k.filter(w=>w.id!==t).map((w,M)=>o(vi,{title:g(`miniMe.${w.name}`),children:o(ki,{onClick:()=>{n(w.id),i(w.name==="empty"?null:`miniMe.${w.name}BubbleText`)},children:w.icon})},M));return a?u(fi,{children:[o(wi,{ref:e,id:"character"}),o(bi,{children:u(an,{direction:"row",spacing:2,children:[o($r,{anchorIcon:k[t].icon,children:p()}),o(yi,{})]})}),o(Ge,{in:Boolean(r),timeout:_,children:o(Ci,{children:o(gi,{show:Boolean(r),text:g(r)})})})]}):null},Ti=c(G)`
  text-transform: none;
  margin: 3vh auto;
`,Di=c(dn)`
  color: ${e=>e.theme.colors.mainwhite};
...
`,je=({description:e,leftSideThumbnail:t})=>o(Ni,{leftSideThumbnail:t,children:e}),qi=c.div`
  grid-column: ${e=>e.leftSideThumbnail?"2/-1":"1/7"};
  display: flex;
  justify-content: ${e=>e.leftSideThumbnail?"flex-end":"flex-start"};
  align-items: flex-end;
`,Ee=({technologies:e,leftSideThumbnail:t})=>o(qi,{leftSideThumbnail:t,children:o(it,{justifyContent:t?"flex-end":"flex-start",technologies:e})}),Xi=c.figure`
...
`,He=({imgUrl:e,altText:t,leftSideThumbnail:n,onClick:r})=>o(Xi,{onClick:r,leftSideThumbnail:n,children:o(Zi,{src:e,alt:t})}),Fe=c.div`
  display: grid;
...
`,Re=c.h4`
  font-size: 1rem;
  color: ${e=>e.theme.colors.mainred};
`,Oi=({projectOverview:e,leftSideThumbnail:t=!0})=>{var i,s;const{t:n}=D();return N(`(max-width: ${T.md})`)?u(Fe,{children:[o(Re,{children:e.subheadline}),o(Ye,{leftSideThumbnail:!1,onClick:()=>alert("Hi"),children:n(e.headline)}),o(He,{leftSideThumbnail:!1,onClick:()=>alert("Hi"),imgUrl:e.imgUrl}),o(je,{leftSideThumbnail:!1,description:n(e.description)}),o(Ee,{leftSideThumbnail:!1,technologies:(s=e.technologies)!=null?s:[]})]}):u(Fe,{children:[o(He,{leftSideThumbnail:t,onClick:()=>alert("Hi"),imgUrl:e.imgUrl}),u(Ui,{leftSideThumbnail:t,children:[u(Vi,{leftSideThumbnail:t,children:[o(Re,{children:e.subheadline}),o(Ye,{leftSideThumbnail:t,onClick:()=>alert("Hi"),children:n(e.headline)})]}),o(je,{leftSideThumbnail:t,description:n(e.description)}),o(Ee,{leftSideThumbnail:t,technologies:(i=e.technologies)!=null?i:[]})]})]})},Gi=c.section`
  width: 85%;
  margin: 0 auto;
`,_i=()=>{const{t:e}=D();return u(Gi,{id:"projects",children:[o(fe,{children:e("sections.projects")}),Wi.map((t,n)=>o(Oi,{projectOverview:t,leftSideThumbnail:n%2===0},n))]})},We=()=>u(R,{children:[o(Hi,{}),o(Qn,{}),o(gr,{}),o(_i,{}),o(Vo,{}),o(yr,{})]}),Ki=c.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
