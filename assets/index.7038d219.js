var mt=Object.defineProperty;var Me=Object.getOwnPropertySymbols;var pt=Object.prototype.hasOwnProperty,ut=Object.prototype.propertyIsEnumerable;var ie=(e,t,n)=>t in e?mt(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Se=(e,t)=>{for(var n in t||(t={}))pt.call(t,n)&&ie(e,n,t[n]);if(Me)for(var n of Me(t))ut.call(t,n)&&ie(e,n,t[n]);return e};var d=(e,t,n)=>(ie(e,typeof t!="symbol"?t+"":t,n),n);import{s as c,j as o,a as u,W as gt,u as z,M as ft,b as ve,T as wt,r as x,F as R,c as ee,I,d as bt,e as Ne,S as yt,l as $,L as xt,N as Ze,R as W,f as P,g as kt,h as Mt,i as q,A as St,k as B,m as vt,n as Ct,C as $t,o as Xe,p as A,q as Tt,B as O,t as Ce,v as Ve,w as Ue,P as zt,x as Ge,y as Dt,D as At,z as Lt,E as It,G as Pt,H as jt,J as Bt,K as Et,O as Ht,Q as Ft,U as Yt,V as Oe,X as Rt,Y as _e,Z as Wt,_ as qt,$ as me,a0 as Nt,a1 as Zt,a2 as Xt,a3 as Vt,a4 as h,a5 as Ut,a6 as D,a7 as C,a8 as X,a9 as f,aa as Gt,ab as Ot,ac as _t,ad as Kt,ae as Qt,af as Ke,ag as Jt,ah as en,ai as tn,aj as nn,ak as on,al as rn,am as sn,an,ao as cn,ap as ln,aq as dn,ar as Qe,as as hn,at as mn,au as se,av as pn,aw as un,ax as gn,ay as fn,az as wn,aA as bn,aB as yn,aC as xn,aD as kn}from"./vendor.395f6baf.js";const Mn=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerpolicy&&(s.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?s.credentials="include":i.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}};Mn();const Sn=c.div`
...
`,Wn=({isMounted:e})=>{const{t:n}=z(),[r,i]=W.useState(!1),s=l=>()=>{i(l)},a=r?o(I,{onClick:s(!1),children:o(Bn,{})}):o(I,{onClick:s(!0),children:o(jn,{})});return u(R,{children:[o(In,{children:u(Pn,{children:[o(P,{in:e,timeout:K,children:o($e,{children:o(et,{})})}),o(P,{in:e,timeout:K+pe,children:o($e,{children:a})})]})}),o(En,{anchor:"bottom",open:r,onClose:s(!1),onOpen:s(!0),swipeAreaWidth:56,disableSwipeToOpen:!1,children:u(Hn,{children:[o(Fn,{}),o(kt,{children:ue.map((l,g)=>o(Mt,{children:o(Yn,{children:o(Rn,{smooth:!0,to:l.url,onClick:s(!1),children:n(l.title)})})}))})]})})]})},qn=c.nav`
  flex: 1;
  display: flex;
  justify-content: end;
  align-items: center;
...
`,Xn=({isMounted:e})=>{const{t}=z();return o(qn,{children:u(Nn,{children:[e&&ue.map((n,r)=>o(P,{in:e,timeout:K+r*pe,children:o(Te,{children:o(Zn,{smooth:!0,to:n.url,children:t(n.title)})},r)},r)),o(P,{in:e,timeout:K+ue.length*pe,children:o(Te,{children:o(et,{})})})]})})},Vn=()=>{const[e,t]=x.exports.useState(!1),n=q(`(max-width: ${T.sm})`);return x.exports.useEffect(()=>{const r=setTimeout(()=>t(!0),Tn);return()=>clearTimeout(r)},[]),n?o(Wn,{isMounted:e}):o(Xn,{isMounted:e})},Un=c(St)`
  flex-direction: row;
  background-color: ${e=>e.theme.colors.mainblack};
  padding: 5px 0;
`,Gn=c(I)`
...
`,_n=({homeClickHandler:e})=>{const t=vt({target:window,threshold:50}),n=q(`(max-width: ${T.md})`);return u(R,{children:[o(P,{direction:"down",in:!t,timeout:_,children:u(Un,{color:"inherit",position:n?"absolute":"fixed",children:[o(P,{direction:"down",in:!t,timeout:_,children:o(Gn,{onClick:e,children:o(On,{})})}),o(Vn,{})]})}),o(Ct,{})]})},Kn=c.h2`
  font-size: 2rem;
  margin-bottom: 5vh;
  width: 100%;
...
`,fe=({children:e})=>o(Kn,{children:e}),Qn=c.section`
  width: 85%;
  height: 100vh;
  margin: 0 auto;
`;function Jn(){const{t:e}=z();return o(Qn,{id:"about",children:o(fe,{children:e("sections.about")})})}var eo="/assets/chatbot-avatar.2885f311.svg";const to=c($t)`
  background-color: ${e=>e.theme.colors.mainblack};
  color: ${e=>e.theme.colors.mainwhite};
...
`,Io=c(Yt)`
  padding: 8px 24px;
`,Po=W.forwardRef(function(t,n){return o(P,Se({direction:"up",ref:n},t))}),jo=(e,t)=>e.map((n,r)=>n.type==="textarea"?o(De,{autoFocus:r===0,multiline:!0,minRows:3,size:"small",name:n.name.toString(),required:n.required,label:t(n.label)}):o(De,{autoFocus:r===0,type:n.type,name:n.name.toString(),required:n.required,label:t(n.label),size:"small"})),Bo=({formElements:e,formSubmitID:t})=>{const{t:n}=z(),[r,i]=x.exports.useState(!1);return x.exports.useEffect(()=>{const s=setTimeout(()=>i(!0),1200);return()=>clearTimeout(s)},[]),u(vo,{open:r,onClose:()=>i(!1),TransitionComponent:Po,children:[u(To,{children:[u(Co,{children:[o(A,{gutterBottom:!0,component:"p",children:"Message me"}),o(A,{variant:"caption",component:"p",children:"I will get back to you as soon as possible."})]}),o($o,{onClick:()=>i(!1),children:o(zo,{})})]}),u(Do,{children:[o(Ao,{}),u(Lo,{method:"POST",action:`https://formsubmit.co/${t}`,id:"contact-form",children:[jo(e,n),o("input",{type:"hidden",name:"_next",value:"https://fredericbahr.github.io"}),o("input",{type:"hidden",name:"_captcha",value:"false"}),o("input",{type:"text",name:"_honey",style:{display:"none"}}),o("input",{type:"hidden",name:"_template",value:"table"})]})]}),u(Io,{children:[o(O,{onClick:()=>i(!1),children:"Cancel"}),o(O,{type:"submit",form:"contact-form",children:"Send"})]})]})},Eo=c.div`
  display: flex;
...
`,Ho=c.p`
  ...
  hyphens: auto;
`,Fo=({children:e,owner:t})=>o(Oe,{in:!0,appear:!0,children:o(Eo,{owner:t,children:o(Ho,{owner:t,children:e})})}),Yo=c(Ue)`
  flex-grow: 1;
`,Ro=c(Ge)`
  flex-wrap: wrap;
  margin-bottom: 1vmax;
...
`,it=({technologies:e=[],justifyContent:t="flex-start"})=>{const{t:n}=z();return o(Go,{justifyContent:t,children:e.map((r,i)=>o(Oo,{children:n(r)},i))})},_o=c(A)`
  margin: 2vh 0;
  width: 85%;
`,Ko=c.ul`
  margin: 2vh 0;
...
`,Jo=e=>Array.isArray(e),er=({description:e,className:t})=>{const{t:n}=z(),r=i=>{const s=i.map((a,l)=>o(Qo,{children:n(a)},l));return o(Ko,{children:s})};return Jo(e)?r(e):o(_o,{children:n(e)})},le=c(A)`
  font-size: 0.9rem;
...
`,Q=({url:e,children:t})=>o(or,{href:e,target:"_blank",children:t}),rr=c.h3`
  display: flex;
`,ir=c(A)``,sr=c(A)`
  margin: 0 10px;
`,ar=({title:e,companyName:t,companyUrl:n})=>u(rr,{children:[o(ir,{component:"span",children:e}),o(sr,{component:"span",children:"@"}),o(Q,{url:n,children:t})]}),cr=c.div`
  flex-grow: 1;
...
`,br=c(A)`
  font-size: 0.65rem;
  margin-top: 0.3rem;
`,yr=()=>u(fr,{children:[o(wr,{children:"Designed & Build by Frederic Bahr"}),u(br,{children:["Inspired by ",o(Q,{url:"https://brittanychiang.com/",children:"Brittany Chiang"})]})]}),xr=({className:e})=>o("svg",{version:"1.0",xmlns:"http://www.w3.org/2000/svg",width:"512.000000pt",height:"512.000000pt",viewBox:"0 0 512.000000 512.000000",preserveAspectRatio:"xMidYMid meet",className:e,children:u("g",{transform:"translate(0.000000,512.000000) scale(0.100000,-0.100000)",fill:"#000000",stroke:"none",children:[o("path",{d:`M2390 5113 c-905 -65 -1713 -614 -2126 -1443 -303 -608 -345 -1300\r
...
`,Ci=c.div`
  ...
  top: 0;
  left: 5%;
`,$i=()=>{const e=x.exports.useRef(null),[t,n]=x.exports.useState(0),[r,i]=x.exports.useState("miniMe.hiBubbleText"),s=6e3,a=q(`(min-width: ${T.md})`),l=G.getMiniMe(),{t:g}=z();x.exports.useEffect(()=>{var ke;const w=new tn;w.clear();const M=new nn(65,window.innerWidth/window.innerHeight,.1,4e3);M.position.set(0,400,-1e3),M.lookAt(new on(0,0,0));const S=new rn({alpha:!0,antialias:!0});S.setPixelRatio(window.devicePixelRatio);const Z=new sn(M,S.domElement);Z.update(),(ke=e.current)==null||ke.replaceChildren(S.domElement);const ne=()=>{const E=new cn(16777215,16777215,.7),F=new ln(4210752,1.2);w.add(E),w.add(F)},oe=()=>{w.add(l.character)};function ht(){const E=S.domElement,F=E.clientWidth,re=E.clientHeight;(E.width!==F||E.height!==re)&&(S.setSize(F,re,!0),M.aspect=F/re,M.updateProjectionMatrix())}const xe=function(){requestAnimationFrame(xe),ht(),Z.update(),S.render(w,M)};ne(),oe(),xe()}),x.exports.useEffect(()=>{l.setGadget(t)},[t]),x.exports.useEffect(()=>{const w=setTimeout(()=>{i(null)},s);return()=>clearTimeout(w)},[r]);const k=[{id:0,icon:o(xi,{}),name:"empty"},{id:1,icon:o(Mi,{}),name:"laptop"},{id:2,icon:o(Si,{}),name:"keyboard"}],p=()=>k.filter(w=>w.id!==t).map((w,M)=>o(vi,{title:g(`miniMe.${w.name}`),children:o(ki,{onClick:()=>{n(w.id),i(w.name==="empty"?null:`miniMe.${w.name}BubbleText`)},children:w.icon})},M));return a?u(fi,{children:[o(wi,{ref:e,id:"character"}),o(bi,{children:u(an,{direction:"row",spacing:2,children:[o($r,{anchorIcon:k[t].icon,children:p()}),o(yi,{})]})}),o(Oe,{in:Boolean(r),timeout:_,children:o(Ci,{children:o(gi,{show:Boolean(r),text:g(r)})})})]}):null},Ti=c(O)`
  text-transform: none;
  margin: 3vh auto;
`,zi=c(dn)`
  color: ${e=>e.theme.colors.mainwhite};
`,Di=({children:e,className:t,onClick:n})=>o(Ti,{onClick:n,className:t,variant:"contained",startIcon:o(zi,{}),children:e});const Ai=c.div`
  display: grid;
...
`,Bi=c(Di)`
  ...
  padding: 1vh 2vw;
  font-size: 1rem;
`,Ei=()=>{const{t:e}=z(),t=Qe(),[n,r]=x.exports.useState(!1),i=()=>{t("contact",{replace:!0})};return x.exports.useEffect(()=>{const s=setTimeout(()=>r(!0),Je);return()=>clearTimeout(s)},[]),o(_e,{in:n,timeout:_,children:u(Ai,{children:[u(Li,{children:[u(Ii,{variant:"h6",component:"p",children:[e("introduction.hi")," "]}),o(hn,{onInit:s=>{s.pauseFor(zn).typeString(e("introduction.name")).pauseFor(ae).deleteAll().typeString(e("introduction.student")).pauseFor(ae).deleteAll().typeString(e("introduction.jobdescription")).pauseFor(ae).deleteAll().typeString(e("introduction.name")).start()}}),o(Pi,{children:e("introduction.subtitle")}),u(ji,{children:[e("introduction.info.firstText")," ",o(Q,{url:"https://www.htwk-leipzig.de/startseite/",children:e("introduction.info.htwkLink")})," ",e("introduction.info.secondText")," ",o(Q,{url:"https://www.ipoque.com/",children:e("introduction.info.jobLink")}),"."]}),o(Bi,{onClick:i,children:"Contact me!"})]}),o($i,{})]})})};var Hi="/assets/dag-visualization.83af4ae2.png",Fi="/assets/dbs_weatherdata.fd6527c9.png",Yi="/assets/domain-specific-languages.d57a8f41.png";const Ri=[{imgUrl:Yi,headline:"projects.dsl.headline",subheadline:"Projects",description:"projects.dsl.description",technologies:["projects.dsl.technologies.0","projects.dsl.technologies.1","projects.dsl.technologies.2","projects.dsl.technologies.3","projects.dsl.technologies.4"]},{imgUrl:Hi,headline:"projects.dag.headline",subheadline:"Projects",description:"projects.dag.description",technologies:["projects.dag.technologies.0","projects.dag.technologies.1","projects.dag.technologies.2","projects.dag.technologies.3","projects.dag.technologies.4"]},{imgUrl:Fi,headline:"projects.weatherData.headline",subheadline:"Projects",description:"projects.weatherData.description",technologies:["projects.weatherData.technologies.0","projects.weatherData.technologies.1","projects.weatherData.technologies.2","projects.weatherData.technologies.3","projects.weatherData.technologies.4","projects.weatherData.technologies.5"]}],Wi=c.p`
  background-color: ${e=>$(e.theme.colors.mainblack,.1)};
...
`,Be=({description:e,leftSideThumbnail:t})=>o(Wi,{leftSideThumbnail:t,children:e}),qi=c.div`
  grid-column: ${e=>e.leftSideThumbnail?"2/-1":"1/7"};
  display: flex;
  justify-content: ${e=>e.leftSideThumbnail?"flex-end":"flex-start"};
  align-items: center;
`,Ee=({technologies:e,leftSideThumbnail:t})=>o(qi,{leftSideThumbnail:t,children:o(it,{justifyContent:t?"flex-end":"flex-start",technologies:e})}),Ni=c.figure`
...
`,He=({imgUrl:e,altText:t,leftSideThumbnail:n,onClick:r})=>o(Ni,{onClick:r,leftSideThumbnail:n,children:o(Zi,{src:e,alt:t})}),Fe=c.div`
  display: grid;
...
`,Re=c.h4`
  font-size: 1rem;
  color: ${e=>e.theme.colors.mainred};
`,Ui=({projectOverview:e,leftSideThumbnail:t=!0})=>{var i,s;const{t:n}=z();return q(`(max-width: ${T.md})`)?u(Fe,{children:[o(Re,{children:e.subheadline}),o(Ye,{leftSideThumbnail:!1,onClick:()=>alert("Hi"),children:n(e.headline)}),o(He,{leftSideThumbnail:!1,onClick:()=>alert("Hi"),imgUrl:e.imgUrl}),o(Be,{leftSideThumbnail:!1,description:e.description}),o(Ee,{leftSideThumbnail:!1,technologies:(s=e.technologies)!=null?s:[]})]}):u(Fe,{children:[o(He,{leftSideThumbnail:t,onClick:()=>alert("Hi"),imgUrl:e.imgUrl}),u(Xi,{leftSideThumbnail:t,children:[u(Vi,{leftSideThumbnail:t,children:[o(Re,{children:e.subheadline}),o(Ye,{leftSideThumbnail:t,onClick:()=>alert("Hi"),children:n(e.headline)})]}),o(Be,{leftSideThumbnail:t,description:n(e.description)}),o(Ee,{leftSideThumbnail:t,technologies:(i=e.technologies)!=null?i:[]})]})]})},Gi=c.section`
  width: 85%;
  margin: 0 auto;
`,Oi=()=>{const{t:e}=z();return u(Gi,{id:"projects",children:[o(fe,{children:e("sections.projects")}),Ri.map((t,n)=>o(Ui,{projectOverview:t,leftSideThumbnail:n%2===0},n))]})},We=()=>u(R,{children:[o(Ei,{}),o(Jn,{}),o(gr,{}),o(Oi,{}),o(Uo,{}),o(yr,{})]}),_i=c.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
...
`,Qi=c.div`
  background-color: ${e=>e.theme.colors.mainblack};
  color: ${e=>e.theme.colors.whitefontcolor};
`;function Ji(){const[e,t]=x.exports.useState(!0),n=Qe(),r=()=>{t(!0),n("/",{replace:!0})};return x.exports.useEffect(()=>{const i=setTimeout(()=>{t(!1)},2800);return()=>clearTimeout(i)},[e]),e?o(_i,{children:o(Ki,{})}):u(Qi,{children:[o(_n,{homeClickHandler:r}),u(mn,{children:[o(se,{path:"/",element:o(We,{})}),o(se,{path:"/contact",element:o(vn,{})}),o(se,{path:"*",element:o(We,{})})]})]})}const es={about:"\xDCber mich",experience:"Erfahrung",projects:"Projekte"},ts={about:"\xDCber mich",experience:"Erfahrungen",projects:"Projekte"},ns={tooltip:"W\xE4hle deine Sprache",english:"Englisch",german:"Deutsch"},os={hi:"Hi, ich bin",name:"Frederic Bahr",student:"ein Medieninformatik Student",jobdescription:"ein Frontend Web Developer",subtitle:"Ich entwickle Assets f\xFCr das Web.",info:{firstText:"Ich bin ein Software Engineer, der sich auf die Entwicklung digitaler Erfahrungen aus der Frontend-Perspektive spezialisiert hat. Derzeit studiere ich Medieninformatik (Master) an der",secondText:"und entwickle UI-Komponenten f\xFCr die",htwkLink:"HTWK",jobLink:"ipoque GmbH"}},rs={tooltip:"Chatbot \xF6ffnen",initialMessage:{firstMessage:"Hi, Ich bin Frederic`s ChatBot \u{1F916}",secondMessage:"Wie kann ich dir helfen?"},sayHello:{actionText:"Ich wollte nur einmal Hallo sagen",firstMessage:"Hi, wie gehts?",secondMessage:"Hey, sch\xF6n dich kennenzulernen!",thirdMessage:"Danke dass du dir mein Portfolio anschaust.",fourthMessage:"Ich hoffe dir gef\xE4llt meine Arbeit.",fifthMessage:"Kann ich dir sonst irgendwie helfen?"},showCV:{actionText:"Zeig mir deinen Lebenslauf.",firstMessage:"Hey, ich interessiere mich f\xFCr deinen Lebenslauf!",secondMessage:"Danke f\xFCr dein Interesse.",thirdMessage:"Unten kannst du meinen Lebenslauf herunterladen."},sendAnotherMessage:{actionText:"Sende eine weitere Nachricht",firstMessage:"Ich w\xFCrde gerne eine weitere Nachricht senden.",secondMessage:"Ok, kein Problem."},directChat:{actionText:"Ich will mit dir pers\xF6nlich reden.",firstMessage:"Ich mag deinen Chatbot sehr, aber ich w\xFCrde gerne mit dir direkt reden.",secondMessage:"Schade, aber ich respektiere deine Entscheidung.",thirdMessage:"Schicke meinem Meister eine Nachricht, er wird so schnell wie m\xF6glich antworten!"},formElementsLabel:{name:"Name",subject:"Betreff",email:"E-Mail",message:"Nachricht"}},is={jobTitles:{"working-student":"Werksstudent",intern:"Praktikum","bachelor-thesis":"Bachelor Thesis "},"time-present":"bis Heute","work-gdmcom":{statement1:"Werkstudent in der Abteilung Informations- und Kommunikationstechnologie",statement2:"Automatisierung von wiederkehrenden Aufgaben im Bereich der Microsoft Office Suite und Dateisystemen",statement3:"Implementierung eines Prototyps f\xFCr die automatisierte Erstellung einer \xDCbersicht von Unternehmensstandorten aus Dateiverzeichnissen"},"work-ipoque-intern":{statement1:"Erstellung generischer Angularkomponenten zur Darstellung von UI-Komponenten in einem Showcase",statement2:"Implementieren der Komponenten mit variablen Konfigurationsmustern zur benutzerdefinierten Steuerung der Visualisierung",statement3:"Automatisiertes Rendern verschiedener Formularelemente aufgrundlage einer benutzerdefinierten Konfiguration"},"work-ipoque-bachelor":{statement1:"Konzeption, Entwurf und Implementierung einer dom\xE4nenspezifischen Sprache f\xFCr die Erstellung von Komponentenquellcode",statement2:"Entwerfen und Implementieren eines Compilers f\xFCr eine eigene Programmiersprache",statement3:"Generierung von generischem Angular-Quellcode und eigene L\xF6sungsans\xE4tze mithilfe von Design Patterns (Modularisierung, Dependency Injection, etc.)"},"work-ipoque-working-student":{statement1:"Weiterentwicklung der DSL und des dazugeh\xF6rigen Compilers mit Implementierung von Plugins f\xFCr diverse IDE\xB4s",statement2:"Entwicklung interner Automatisierungsskripte f\xFCr die Continuous Delivery-Pipeline",statement3:"Entwicklung von Unit-Tests f\xFCr alle Module des Compilers"}},ss={dsl:{headline:"Dom\xE4nenspezifische Sprache",description:"Eine dom\xE4nenspezifische Sprache f\xFCr die unkomplizierte und ausdrucksstarke Erstellung eines Showcases f\xFCr UI-Komponenten.",technologies:["Compiler","JavaScript","VSC Extension","Intellij Plugin","Betriebsgeheimnis"]},dag:{headline:"Gerichteter azyklischer Graph Visualisierung",description:"Eine Implementierung des Sugiyama-Algorithmus unter Verwendung der Barycenter-Heuristik. Die App visualisiert einen gerichteten azyklischen Graphen mit Hilfe von D3.",technologies:["TypeScript","D3.js","Algorithmen","Visualisierung","Universit\xE4t"]},weatherData:{headline:"XML Wetterdaten Visualisierung",description:"",technologies:["XML","XML Schema Definition","DTD","XSL Transformation","D3.js","Universit\xE4t"]}};var as={sections:es,navbar:ts,languageMenu:ns,introduction:os,chatbot:rs,experience:is,projects:ss};const cs={about:"About me",experience:"Experience",projects:"Projects"},ls={about:"About me",experience:"Experience",projects:"Projects"},ds={tooltip:"Select a language",english:"English",german:"German"},hs={hi:"Hi, I am",name:"Frederic Bahr",student:"a Media Informatics student",jobdescription:"a Frontend Web Developer",subtitle:"I develop occasionally well assets for the web.",info:{firstText:"I\xB4m a Software Engineer spezializing in building digital experience from the frontend perspective. Currently studying Media Informatics (Master) at",secondText:"and developing UI-Components at",htwkLink:"HTWK",jobLink:"ipoque GmbH"}},ms={gadget:"Select a gadget",empty:"Nothing",laptop:"Laptop",keyboard:"Keyboard",hiBubbleText:"Hello there! Come play with me",laptopBubbleText:"Look, my new laptop!",keyboardBubbleText:"Look, my new keyboard!"},ps={tooltip:"Open the chatbot",initialMessage:{firstMessage:"Hi, I\xB4m Frederic`s ChatBot \u{1F916}",secondMessage:"How can i help you?"},sayHello:{actionText:"I just wanted to say hello",firstMessage:"Hi, whats up?",secondMessage:"Well hello there, nice to meet you!\u{1F44B}",thirdMessage:"Thanks for looking at my personal website.",fourthMessage:"I hope you enjoy my work.",fifthMessage:"Can I help you with anything else?"},showCV:{actionText:"I want to see your CV.",firstMessage:"Hey, im interested in your CV!",secondMessage:"Thanks for reaching out to me.",thirdMessage:"Underneath you can download my CV."},sendAnotherMessage:{actionText:"Send another message",firstMessage:"I would like to send another message.",secondMessage:"Ok, no problem."},directChat:{actionText:"I want to talk to you directly.",firstMessage:"I really like your Chatbot, but i would rather talk to you directly.",secondMessage:"Sad times, but I respect your decision.",thirdMessage:"Send my master a message and he will answer as soon as possible!"},formElementsLabel:{name:"Name",subject:"Subject",email:"E-Mail",message:"Message"}},us={jobTitles:{"working-student":"Working Student",intern:"Internship","bachelor-thesis":"Bachelor Thesis "},"time-present":"Present","work-gdmcom":{statement1:"Working student in the Information and Communication Technology department",statement2:"Automation of recurring tasks in the domain of Microsoft Office Suite and file storages",statement3:"Implementing a prototype for the automated creation of an overview of business locations from file directories"},"work-ipoque-intern":{statement1:"Creation of generic Angular components to display UI-components in a showcase",statement2:"Implementing the components with variable configuration patterns for user-defined control of the resulting visualization",statement3:"Automated rendering of various form elements based on a custom configuration"},"work-ipoque-bachelor":{statement1:"Conception, design and implementation of a domain-specific language for the creation of component source code",statement2:"Designing and implementing a compiler for a custom programming language",statement3:"Generation of generic Angular source code and own solution approaches using design patterns (modularization, dependency injection, etc.)"},"work-ipoque-working-student":{statement1:"Further development of the DSL and the associated compiler with implementation of plugins for various IDEs",statement2:"Development of internal automation scripts for the continuous delivery pipeline",statement3:"Development of unit tests for all modules of the compiler"}},gs={dsl:{headline:"Domain-specific language",description:"A domain-specific language for the easy and expressive creation of a showcase for UI-components.",technologies:["Compiler","JavaScript","VSC Extension","Intellij Plugin","Company Confidential"]},dag:{headline:"Directed Acyclic Graph Visualization",description:"An implementation of the sugiyama algorithm using the barycenter heuristic. The app visualize a directed acyclic graph with the help of D3.",technologies:["TypeScript","D3.js","Algorithms","Visualization","University"]},weatherData:{headline:"XML Wether Data Visualization",description:"",technologies:["XML","XML Schema Definition","DTD","XSL Transformation","D3.js","University"]}};var fs={sections:cs,navbar:ls,languageMenu:ds,introduction:hs,miniMe:ms,chatbot:ps,experience:us,projects:gs};const ws={en:{translation:fs},de:{translation:as}},bs={order:["querystring","navigator"],lookupQuerystring:"lng"};pn.use(un).use(gn).init({resources:ws,detection:bs,fallbackLng:"en",interpolation:{escapeValue:!1}});const ys="modulepreload",qe={},xs="/",ks=function(t,n){return!n||n.length===0?t():Promise.all(n.map(r=>{if(r=`${xs}${r}`,r in qe)return;qe[r]=!0;const i=r.endsWith(".css"),s=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${s}`))return;const a=document.createElement("link");if(a.rel=i?"stylesheet":ys,i||(a.as="script",a.crossOrigin=""),a.href=r,document.head.appendChild(a),i)return new Promise((l,g)=>{a.addEventListener("load",l),a.addEventListener("error",g)})})).then(()=>t())},Ms=e=>{e&&e instanceof Function&&ks(()=>import("./web-vitals.d62816c8.js"),[]).then(({getCLS:t,getFID:n,getFCP:r,getLCP:i,getTTFB:s})=>{t(e),n(e),r(e),i(e),s(e)})},Ss=fn({typography:{fontFamily:["Fira Code","Roboto",'"Oxygen"','"Ubuntu"','"Cantarell"','"Fira Sans"','"Droid Sans"','"Helvetica Neue"',"sans-serif"].join(",")},palette:{primary:{main:"#cc0e00"}}}),vs={colors:{mainblack:"#181114",mainwhite:"#fbfffe",mainred:"#cc0e00",whitefontcolor:"#fbfffe"}};wn.render(o(W.StrictMode,{children:o(bn,{children:o(yn,{injectFirst:!0,children:o(xn,{theme:Ss,children:u(kn,{theme:vs,children:[o($n,{}),o(Ji,{})]})})})})}),document.getElementById("root"));Ms();
